# taken from https://stackoverflow.com/questions/9073446/where-do-you-store-your-rails-applications-version-number/23135266
# rake version | grep 'Current version is:' | awk 'BEGIN { FS="[ ]" } ; { print $4 }'
def valid? version
...
rake version:help             # print this message
HELP
